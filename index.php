 ...
 */
  ...
  if (function_exists('isFromRecommend')) {
  	isFromRecommend();
  }
 ...
 */
  ...
  //added by changanti
  if($_SERVER['HTTP_HOST']=='test1.ecat-shop.com'){
 ...
 */
  ...
  if (isset($user_in_center) && $user_in_center == true) {
  	require($template->get_template_dir('html_header_account.php',DIR_WS_TEMPLATE, $current_page_base,'common'). '/html_header_account.php');
  }else{
 ...
 */
  if (isset($user_in_center) && $user_in_center == true) {
  	require($template->get_template_dir('tpl_main_page_account.php',DIR_WS_TEMPLATE, $current_page_base,'common'). '/tpl_main_page_account.php');
  } else {
