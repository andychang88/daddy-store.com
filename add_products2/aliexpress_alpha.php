...
'start_str'=>'<div id="product-info-sku"',
'end_str'=>'<dl id="product-info-quantity" class="product-info-quantity">',
'preg'=>'',
'use_extract'=>true,
...
'start_str'=>'<div class="ui-box ui-box-normal product-params">',
'end_str'=>'<div id="transaction-history">',
'preg'=>'',
'use_extract'=>true,
'extract_arr'=>array(
		     array(
...
'start_str'=>'<h1 class="product-name" itemprop="name">',
'end_str'=>'</h1>',
);
$price_filter_content_arr = array(
'start_str'=>'sku-discount-price',
'end_str'=>'</div>',
'addition'=>array(
