 ...
 */
  ...
  if (isset($_POST['edit_x']) || isset($_POST['edit_y'])) {
    ...
    $sql_data_array = array('products_quantity' => $products_quantity,
							...
							'products_stock_status'=>zen_db_prepare_input($_POST['products_stock_status']),
...
if ($_POST['image_delete'] == 1) {
    ...
    if ($action == 'insert_product') {
	  ...
	  //20110608 hezhen auto add attributes
$parent_id = substr($cPath,4,3);
$categories=array(115,130,332,358,359,360,361);
...
(".$products_id.", 3, 8, '0.0000', '+', 1, 1, 0, '+', 0, 0, 1, '', 1, '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '', '', '0.0000', 0, '0.0000', 0, 0),
(".$products_id.", 3, 16, '22.0000', '+', 4, 1, 0, '+', 0, 0, 0, '', 1, '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '', '', '0.0000', 0, '0.0000', 0, 0),
(".$products_id.", 4, 11, '14.0000', '+', 5, 1, 10, '+', 0, 0, 0, '', 1, '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '', '', '0.0000', 0, '0.0000', 0, 0),
(".$products_id.", 4, 12, '28.0000', '+', 2, 1, 10, '+', 0, 0, 0, '', 1, '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '', '', '0.0000', 0, '0.0000', 0, 0),
(".$products_id.", 4, 13, '48.0000', '+', 3, 1, 10, '+', 0, 0, 0, '', 1, '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '', '', '0.0000', 0, '0.0000', 0, 0),
(".$products_id.", 4, 14, '59.9900', '+', 4, 1, 10, '+', 0, 0, 0, '', 1, '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '', '', '0.0000', 0, '0.0000', 0, 0),
(".$products_id.", 4, 15, '0.0000', '+', 1, 1, 0, '+', 0, 0, 0, '', 1, '0.0000', '0.0000', '0.0000', '0.0000', '0.0000', '', '', '0.0000', 0, '0.0000', 0, 0);";
$result = mysql_query($sql);
    ...
    for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
      ...
      $sql_data_array = array('products_name' => zen_db_prepare_input($_POST['products_name'][$language_id]),
							  ...
							  'products_short_description' => zen_db_prepare_input($_POST['products_short_description'][$language_id]),		  
							  'products_photo_html' => zen_db_prepare_input($_POST['products_photo_html'][$language_id]),
