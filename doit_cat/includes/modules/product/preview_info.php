...
//auto replace with defined missing image
      ...
      <tr>
        <td class="main">
          <?php
             echo $pInfo->products_short_description;            
          ?>
        </td>
      </tr>
<?php
...
/* Re-Post all POST'ed variables */
      ...
      for ($i=0, $n=sizeof($languages); $i<$n; $i++) {
		...
		echo zen_draw_hidden_field('products_short_description[' . $languages[$i]['id'] . ']', htmlspecialchars(stripslashes($products_short_description[$languages[$i]['id']])));
		echo zen_draw_hidden_field('products_photo_html[' . $languages[$i]['id'] . ']', htmlspecialchars(stripslashes($products_photo_html[$languages[$i]['id']])));
