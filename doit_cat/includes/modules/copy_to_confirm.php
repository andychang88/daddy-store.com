...
// Copy attributes to duplicate product
          ...
          if ($_POST['copy_as'] == 'link') {
            ...
            $product = $db->Execute("select products_type, products_quantity, products_model,products_afterbuy_model, 
			                                products_image,products_price, products_virtual, products_date_available, products_weight,
											...
											products_quantity_order_max, products_sort_order,
            ...
            $db->Execute("insert into " . TABLE_PRODUCTS . "
                                      (products_type, products_quantity, products_model,products_afterbuy_model,
									   products_image,products_price, products_virtual, products_date_added, products_date_available,
                                       products_weight,products_status,products_stock_status, products_tax_class_id,manufacturers_id,
                          ...
                          values ('" . zen_db_input($product->fields['products_type']) . "',
								  ...
								  '" . zen_db_input($product->fields['products_afterbuy_model']) . "',		  
                                  ...
                                  '" . $products_weight . "', '0',
								  ".zen_db_input($product->fields['products_stock_status']).",
            ...
            $description = $db->Execute("select language_id, products_name, products_description,products_short_description,
                                                products_photo_html,products_url
                                         from " . TABLE_PRODUCTS_DESCRIPTION . "
                                         where products_id = '" . (int)$products_id . "'");
            while (!$description->EOF) {
              $db->Execute("insert into " . TABLE_PRODUCTS_DESCRIPTION . "
                                        (products_id, language_id, products_name, products_description,products_short_description,
                                         products_photo_html,products_url, products_viewed)
                            values ('" . (int)$dup_products_id . "',
									...
									'" . zen_db_input($description->fields['products_short_description']) . "',
									'" . zen_db_input($description->fields['products_photo_html']) . "',
