...
// | http://www.toprc.de/license/2_0.txt.                             |
// | If you did not receive a copy of the zen-cart license and are unable |
// | to obtain it through the world-wide-web, please send a note to       |
// | license@toprc.de so we can mail you a copy immediately.          |
// +----------------------------------------------------------------------+
...
// email disclaimer
  ...
  define('EMAIL_FOOTER_COPYRIGHT','Copyright (c) ' . date('Y') . ' <a href="http://www.toprc.de" target="_blank">toprc team</a>. Powered by <a href="http://www.toprc.de" target="_blank">toprc.de</a>');
