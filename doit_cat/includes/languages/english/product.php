...
define('TEXT_PRODUCT_AVAILABLE', 'Show');

define('TEXT_PRODUCT_NOT_AVAILABLE', 'Hide');
...
//added by john 2010-07-06

define('TEXT_PRODUCTS_SHORT_DESCRIPTION', 'kurz beschreibung:');

define('TEXT_PRODUCTS_PHOTO','Products Photo');
...
define('TEXT_PRODUCTS_STOCK_STATUS','Stock status:');
define('TEXT_PRODUCT_OUT_OF_STOCK','Out of Stock');
define('TEXT_PRODUCT_IN_STOCK','In Stock');
define('TEXT_PRODUCT_BEING_PURCHASED','being purchased...');
define('TEXT_PRODUCT_PRE_SALE','Coming up ...');
