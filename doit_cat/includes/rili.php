...
loadcalendar();
         ...
         <?php echo zen_draw_form('daoc', FILENAME_CUSTOMERS_XLS, '', 'get', '', true); ?>
		  客户创建日期&nbsp;<input type="text" name="xsj" readonly onclick="showcalendar(event,this);" onfocus="showcalendar(event, this);if(this.value=='0000-00-00')this.value=''">
		  &nbsp;到&nbsp;<input type="text" name="dsj" readonly onclick="showcalendar(event,this);" onfocus="showcalendar(event, this);if(this.value=='0000-00-00')this.value=''">
		  <input type="submit" value="导出" name="daoc" style="border:solid 1px #76D3EF; background-color:#F0F0F0; width:60px;" />
		 </form>
