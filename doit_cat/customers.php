...
<!-- add css 2011-3-23 -->
<link rel="stylesheet" type="text/css" href="includes/rili.css">
<fieldset>
		  ...
		  if ($customers_newsletter == 1) {
			if ($subscribers->fields['count'] > 0) {
			  ...
			  $db->Execute("INSERT INTO " . TABLE_SUBSCRIBERS . "
						    ...
						    VALUES ('" . (int)$customers_id . "', '" . zen_db_input($customers_email_address) . "', 
							        '" . zen_db_input($customers_email_format) . "', now(), '1')");
			}
		  } else {
			if ($subscribers->fields['count'] > 0) {
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading"><?php echo HEADING_TITLE; ?></td>
	<td>
			<?php require(DIR_WS_INCLUDES . 'rili.php'); ?>
