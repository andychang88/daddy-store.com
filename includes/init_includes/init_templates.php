...
/**
 * The actual template button directory to use
 */
   //for convience added by john 2010-07-02
   define('DIR_WS_TEMPLATE_BUTTON',DIR_WS_TEMPLATE . 'buttons/'.$_SESSION['language'].'/');
/**
