...
define('STRICT_ERROR_REPORTING', 0);
...
/*****added by john 2010-10-11***********/
if(isset($_COOKIE['pid_history_str'])&& (!isset($_SESSION['recent_products1'])) ){
  //$_SESSION['recent_products1']=unserialize($_COOKIE['pid_history']);
  /*foreach($_COOKIE['pid_history'] as $rpc_id){
     $_SESSION['recent_products1'][]=$rpc_id;
  }*/
  $_SESSION['recent_products1']=explode(',',$_COOKIE['pid_history_str']);
}
