...
define('SUBSCRIBE_DUPLICATE_CUSTOMERS_ERROR','Fehler! Es gibt bereits eine Kunden-Konto mit dieser E-Mail-Adresse. Um den Newsletter abonnieren, bitte melden Sie an und wählen Sie den Link <a href="index.php?main_page=login"> Einloggen </a> oben rechts. Klicken Sie hier, wenn Sie Ihr <a href="index.php?main_page=password_forgotten">Passwort vergessen</a> haben. ');
