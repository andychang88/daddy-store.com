...
define('MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_TXT', 'Express Checkout with PayPal');
...
define('MODULE_PAYMENT_PAYPALWPP_LOGO_ICON','<img src="images/paypal_ec_icon.gif" alt="'.MODULE_PAYMENT_PAYPALWPP_TEXT_BUTTON_ALTTEXT.'" title="' . MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_TXT . '"/>');
?>