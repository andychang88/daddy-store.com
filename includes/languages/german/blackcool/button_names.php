 ...
 * @version $Id: button_names.php 293 2008-05-28 21:10:40Z maleborg $
 */
...
define('BUTTON_IMAGE_EDIT_SMALL', 'button_small_edit.gif');
...
define('BUTTON_IMAGE_UPDATE2', 'button_update2.gif');
...
define('BUTTON_PRINT_ALT','Drucken');
define('BUTTON_REGISTER_ALT','Anmelden');
//added by john 2010-04-12
define('BUTTON_IMAGE_NEWSLETTER','button_newsletter_send.gif');
define('BUTTON_SMALL_VIEW','button_small_view.gif');
define('BUTTON_IMAGE_PRINT','button_print.gif');
define('BUTTON_IMAGE_SMALL_DELETE','button_small_delete.gif');
define('BUTTON_IMAGE_SMALL_EDIT','button_small_edit.gif');
define('BUTTON_IMAGE_REGISTER', 'button_register.gif');
?>