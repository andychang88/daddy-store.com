...
define('TEXT_INFORMATION_CONFIRM', '
  Bevor Sie beginnen, Ihre Newsletter-Abonnements zu unserem, müssen Sie auf unsere Antwort-subscribe bestätigen Anfrage an Ihre E-Mail:<strong>%s</strong>.
  <br />
  <br />
  Bitte überprüfen Sie Ihre E-Mail-Posteingang. Wenn Sie erhalten die Bestätigung anfordern, klicken Sie einfach auf den Bestätigungs-Link per E-Mail in der beiliegenden. .
  <br />
  <br />
  Wenn Sie Probleme haben, bis der Unterzeichnung, senden Sie bitte eine Nachricht an <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '">'. STORE_OWNER_EMAIL_ADDRESS .'</a>.
  ');
