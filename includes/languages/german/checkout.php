...
define('TABLE_HEADING_COMMENTS', 'Besondere Anweisungen oder Kommentare für Bestellung'); 
...
//TEXT
define('TEXT_CHOOSE_SHIPPING_DESTINATION', 'Ihre Bestellung wird an die Adresse links versandt. Sie können die Lieferadresse ändern, indem Sie auf die Schaltfläche <em>Adresse ändern</em> klicken.'); 
define('TEXT_SELECTED_BILLING_DESTINATION', 'Ihre Rechnungsadresse ist links angezeigt. Sie können die Rechnung-sadresse ändern, indem Sie auf die Schaltfläche <em>Adresse ändern</em> klicken.'); 
...
define('TEXT_CONFIRM_CHECKOUT', '- und setzen Sie fort, um die Bestellung zu schliessen');
