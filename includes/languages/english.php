...
// include template pop dialog defines  (zhengcongzhen 2011-03-28)
  if(file_exists(DIR_WS_LANGUAGES . $_SESSION['language'] . '/' . $template_dir . '/footer.php')){
  	$template_dir_select = $template_dir . '/';
  }else{
  	$template_dir_select = '';
  }
  require_once(DIR_WS_LANGUAGES . $_SESSION['language'] . '/' . $template_dir_select . 'footer.php');
