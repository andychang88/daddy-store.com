 ...
 */
  ...
  define('MODULE_PAYMENT_PAYPAL_ACCEPTANCE_MARK_TEXT', 'Save time. Check out securely. <br />Paypal E-check payment needs to be clear before the delivery.');
  ...
  //for more friendly show
//added by john 2010-06-25
define('MODULE_PAYMENT_PAYPAL_LOGO_ICON','<img src="images/paypal.gif" alt="'.MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_ALT.'" title="' . MODULE_PAYMENT_PAYPALWPP_MARK_BUTTON_ALT . '"/>');
//begin weixuefeng 20110416 
define('MODULE_PAYMENT_PAYPAL_EXTRA_ICON','<img src="/images/payicon.gif" />');
//end
?>