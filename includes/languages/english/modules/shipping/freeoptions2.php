...
define('MODULE_SHIPPING_FREEOPTIONS2_TEXT_TITLE', 'China Registered Airmail Free');
define('MODULE_SHIPPING_FREEOPTIONS2_TEXT_DESCRIPTION', 'Free Options is used to display a Free Shipping option when other Shipping Modules are displayed.It can be based on: Always show, Order Total, Order Weight or Order Item Count.
...
See: freeshipper
');
//define('MODULE_SHIPPING_FREEOPTIONS2_TEXT_WAY', 'Free Shipping');
define('MODULE_SHIPPING_FREEOPTIONS2_TEXT_WAY', '7-25 Days, with tracking number');
?>