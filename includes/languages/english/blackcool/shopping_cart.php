...
//begin weixuefeng 20110426 一些购物车常量的定义
 define('TEXT_EMPTY_CART','You do not have anything in your shopping cart.');
  
   define('TEXT_CONTINUE_SHOPPING','Continue shopping');
   define('TEXT_GOTO_CHECKOUT','Checkout');
  define('TEXT_ITEM_REMOVE_TIP','Are you sure you want to remove this item from your shopping cart?');
   define('TEXT_ITEM_MINUS_TIP','You want to delete this item? If yes, please click the Remove button.');
   //end
?>