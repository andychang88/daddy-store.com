<?php
  ...
  define('EMAIL_TEXT', '  ');
  define('EMAIL_CONTACT', 'At any time you can connect to the "<a href="'.zen_href_link('login').'">My Account</a>", you can track your orders in real time, manage your personal information, access to practical information.'."\n\n".'Thanks again for selecting us: The Chinese professional tablet pc, mobile phone, electronics supplier.'."\n\n".'Should you have any questions, please feel free to contact us by sending an email to: '.STORE_OWNER_EMAIL_ADDRESS.' at any time!'."\n\n");
