...
define('TEXT_SELECT_PAYMENT_METHOD_ONE', 'Payment method for this order');
define('TEXT_SELECT_SHIPPING_METHOD','Please select a shipping method for this order'); 
...
// eof
define('TEXT_NEW_ADDRESS','Please use this form to a new address for your Order to capture');
define('TEXT_NEW_ADDRESS_TITLE','New Address');
define('TEXT_DATA_REQUIRED','* Necessary Information');
define('TEXT_COMPANY_TITLE','Company data');
define('TEXT_COMPANY','Company data');
define('TEXT_GENDER','Title:');
define('TEXT_FIRTNAME','First name:');
define('TEXT_LASTNAME','Name:');
define('TEXT_USTID','Tax ID:');
define('TEXT_ADDRESS','Your Address');
define('TEXT_STREET','Street / No.:');
define('TEXT_SUBURB','District:');
define('TEXT_POSTCODE','ZIP code:');
define('TEXT_CITY','Location:');
define('TEXT_ZONE','Zone');
define('TEXT_STATE','State:');
define('TEXT_COUNTRY','Country:');
define('TEXT_MORE_EXTRA_ADDRESS_DETAIL','More Details (Click and Write)');
define('TEXT_FINISH_ADDRESS','Fill in shipping address');
?>