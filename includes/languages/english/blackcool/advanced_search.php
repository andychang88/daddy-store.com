...
define('TEXT_YOUR_SEARCH','Your Search:');
define('TEXT_SEARCH_NO_RESULT','Sorry, your search returned no results.');
define('TEXT_SEARCH_TIP_TITLE','Search Tips');
define('TEXT_SEARCH_TIP_SPELLING','Double-check your spelling');
define('TEXT_SEARCH_TIP_SHORT','Use fewer words that are more generic.');
?>