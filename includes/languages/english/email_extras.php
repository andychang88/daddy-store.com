 ...
 * @license http://www.myefox.com/license/2_0.txt GNU Public License V2.0
...
// email disclaimer
  ...
  define('EMAIL_FOOTER_COPYRIGHT','Copyright (c) ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>. Powered by <a href="'.HTTP_SERVER.'" target="_blank">'.STORE_NAME.'</a>');
...
// for when gethost is off
  ...
  //added by john 2010-06-18 afterbuy
define('EMAIL_TEXT_AFTERBUY_ID_TIP1','afterbuy sn:');
...
define('EMAIL_TEXT_OVERSEA','Bank Account for customers from <b>Oversea</b>:');
?>