...
//begin weixuefeng 20110408 定义添加到购物车不跳转时的一些变量
  define('TEXT_ADD_ITEM_SUCCESS_TIP','This item is in your cart now !');
  define('TEXT_ITEM_COUNT_NOW','%s Items in Cart');
  define('TEXT_ITEM_SUM_NOW','Total:');
  define('TEXT_A_TITLE_CHECK_OUT','Add to Shopping Cart');
  define('TEXT_SHOPPING_AGAIN','Continue Shopping');
   define('TEXT_SELECT_ITEM_ATTRI','Please select');
   define('TEXT_PRODUCT_WAREHOUSE_LOCATION_TEXT','Item location:');
   define('TEXT_PRODUCT_NO_MORE','For pricing above 40 pieces, please <a href="http://www.myefox.com/contact_us" title="contact us">contact us</a>');
//end
