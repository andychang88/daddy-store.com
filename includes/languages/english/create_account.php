...
define('EMAIL_WELCOME', 'Congratulations! You have successfully registered with Myefox.com .Welcome to <strong>' . STORE_NAME . '</strong> and become a member of us!');
define('EMAIL_SEPARATOR', '--------------------');
define('EMAIL_COUPON_INCENTIVE_HEADER', 'Myefox.com thank you for your choosing and would like to give you a gift discount coupon valued 5 USD (Code is: 4a9bda0e0f).' . "\n\n");
...
define('EMAIL_TEXT', 'At any time you can connect to the "<a href="http://www.myefox.com/login">My Account</a>", you can track your orders in real time, manage your personal information, access to practical information.'."\n\n".'Thanks again for selecting us: The Chinese professional tablet pc, mobile phone, electronics supplier.');
...
define('EMAIL_CONTACT', 'Should you have any questions, please feel free to contact us by sending an email to: : <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '">'. STORE_OWNER_EMAIL_ADDRESS ." </a> at any time!\n\n");
//define('EMAIL_GV_CLOSURE','Sincerely,' . "\n\n" . STORE_OWNER . "\nStore Owner\n\n". '<a href="' . HTTP_SERVER . DIR_WS_CATALOG . '">'.HTTP_SERVER . DIR_WS_CATALOG ."</a>\n\n");
define('EMAIL_GV_CLOSURE','Enjoy your shopping journey with Myefox!'. "\n\n" .'Gong Xi Fa Cai!'. "\n\n" .'Myefox Customer Service Center'. "\n\n" .'Know more about us, please visit '.'<a href="' . HTTP_SERVER . DIR_WS_CATALOG . '">'.HTTP_SERVER . DIR_WS_CATALOG ."</a>\n\n");
