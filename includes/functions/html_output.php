 ...
 * @version $Id: html_output.php 89 2008-12-29 20:12:57Z yellow1912 $
 * @modification: edited to add Simple SEO URL support
 */
 ...
 */
  function zen_href_link($page = '', $parameters = '', $connection = 'NONSSL', $add_session_id = true, $search_engine_safe = true, $static = false, $use_dir_ws_catalog = true) {
    ...
    //bof simple seo url
    global $ssu;
    if(is_object($ssu) && ($link = $ssu->ssu_link($page, $parameters, $connection, $add_session_id, $search_engine_safe, $static, $use_dir_ws_catalog))!= false){
    	return $link;
    }
    //eof simple seo url
