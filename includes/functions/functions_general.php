...
////
  function zen_not_null($value) {
    ...
    } elseif(  $value instanceof queryFactoryResult) {
...
// enable shipping
  function zen_get_shipping_enabled($shipping_module) {
    ...
    $free_shipping_items = $_SESSION['cart']->free_shipping_items();
    ...
    switch(true) {
      ...
      case (ORDER_WEIGHT_ZERO_STATUS == '1' and ($check_cart_weight == 0 and $shipping_module != 'freeshipper')):
        return false;
        break;
      case (($free_shipping_items == $check_cart_cnt) and $shipping_module == 'freeshipper'):
        return true;
        break;
      case (($free_shipping_items == $check_cart_cnt) and $shipping_module != 'freeshipper'):
        return false;
