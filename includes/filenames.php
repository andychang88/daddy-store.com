...
define('FILENAME_DEFINE_ABOUT_MYEFOX','define_about_ours');
define('FILENAME_DEFINE_YH_CONTACT_US','define_yh_contact_us');
define('FILENAME_DEFINE_ESTIMATE_DELIVERY_TIME','define_Estimate_Delivery_Time');
define('FILENAME_DEFINE_LOCATIONS_WE_SHIP_TO','define_Locations_We_Ship_To');
define('FILENAME_DEFINE_OUR_GUARANTEE','define_Our_Guarantee');
define('FILENAME_DEFINE_PAYMENT_METHODS','define_Payment_Methods');
define('FILENAME_DEFINE_PRIVACY_NOTICE','define_Privacy_Notice');
define('FILENAME_DEFINE_RETURN_POLICY','define_Return_Policy');
define('FILENAME_DEFINE_SHIPPING_METHODS_GUIDE','define_Shipping_Methods_Guide');
define('FILENAME_DEFINE_TERMS_OF_USE','define_Terms_of_Use');
define('FILENAME_DEFINE_TRACK_YOUR_ORDER','define_Track_Your_Order');
...
define('FILENAME_DEFINE_TERMS_OF_USE','define_Terms_of_Use');
define('FILENAME_DEFINE_TRACK_YOUR_ORDER','define_Track_Your_Order');
define('FILENAME_CUSTOMERS_XLS','customers_xls');
