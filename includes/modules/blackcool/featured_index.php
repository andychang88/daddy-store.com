...
$featured_products_query = "select distinct p.products_id, p.products_image,p.products_price,
                                            pd.products_name
...
if ($num_products_count > 0) {
  ...
  while (!$featured_products_db->EOF) {
	...
	$featured_products[]=array('products_name'  => zen_get_products_name( $f_pid ),
	                           'products_price' => $featured_products_db -> fields['products_price'],
							   'products_image' => $featured_products_db -> fields['products_image'],
							   'products_url_link'=>zen_href_link(FILENAME_PRODUCT_INFO,'products_id='.$f_pid)
							   );	
