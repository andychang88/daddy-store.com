...
$(document).ready(function(){	   
	   ...
	   $('#new_payment_address_form').validate({
	                      event:'blur',
						  rules:{
						         firstname:{
								           required:true,
						  ...
						  messages:{
								...
								//	 postcode:{
										//	   required:'<br/><?php echo ENTRY_POST_CODE_ERROR; ?>',
										//	   number:'<br/>here must be number',
											   minlength:'<br/><?php echo ENTRY_POST_CODE_ERROR; ?>'
								//	 },
									 city:{
...
function check_new_payment_address_form(){
      return $('#new_payment_address_form').valid();
}
function check_choose_payment_address_form(){
