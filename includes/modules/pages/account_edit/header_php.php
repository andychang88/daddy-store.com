...
if (isset($_POST['action']) && ($_POST['action'] == 'process')) {
  ...
  if (ACCOUNT_DOB == 'true') $dob = (empty($_POST['dob']) ? zen_db_prepare_input('01-01-0001 00:00:00') : zen_db_prepare_input($_POST['dob']));
  ...
  if ($error == false) {
    ...
    if (ACCOUNT_DOB == 'true') {
      if ($dob == '01-01-0001 00:00:00' or $_POST['dob'] == '') {
...
$dob = ($dob == '01-01-0001 00:00:00') ? '' : $dob;
