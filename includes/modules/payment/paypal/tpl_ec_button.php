...
<!--<div id="PPECbutton" class="buttonRow">-->
  <a href="<?php echo zen_href_link('ipn_main_handler.php', 'type=ec', 'SSL', true, true, true); ?>">
   <?php echo zen_image($template->get_template_dir('btn_xpressCheckout.gif',
													 DIR_WS_TEMPLATE,
													 $current_page_base,
													 'buttons/' . $_SESSION['language']).'/btn_xpressCheckout.gif',
                         MODULE_PAYMENT_PAYPALWPP_TEXT_BUTTON_ALTTEXT
						 );
    ?>
  </a>
<!--</div>-->
