...
class cc extends base {
  ...
  function selection() {
    ...
    $selection = array('id' => $this->code,
                       'module' => $this->title,
    				   'icon' => MODULE_PAYMENT_CC_LOGO_ICON,//added by andy
                       'fields' => array(array('title' => MODULE_PAYMENT_CC_TEXT_CREDIT_CARD_OWNER,
                                               'field' => zen_draw_input_field('cc_owner', 
                                         ...
                                         array('title' => MODULE_PAYMENT_CC_TEXT_CREDIT_CARD_EXPIRES,
                                               'field' => zen_draw_pull_down_menu('cc_expires_month', 
																				  $expires_month,
																				  '', 
																				  'id="'.$this->code.'-cc-expires-month"' . $onFocus) . '&nbsp;' .
											              zen_draw_pull_down_menu('cc_expires_year', 
																				  $expires_year,  
																				  '', 
