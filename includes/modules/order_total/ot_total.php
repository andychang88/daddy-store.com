  ...
  class ot_total {
    ...
    function process() {
      global $order, $currencies;
		 ...
		 if($_SESSION['insurance']!="" && $_SESSION['insurance']==1){
			  $this->output[] = array('title' => $this->title . ':',
									  'text' => $currencies->format($order->info['total'], true, $order->info['currency'], $order->info['currency_value']).'(Insurance:'.$currencies->format($order->info['subtotal']*0.031).')',
