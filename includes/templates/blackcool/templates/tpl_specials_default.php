...
<?php
	  ...
	  if (($specials_split->number_of_rows > 1) && ((PREV_NEXT_BAR_LOCATION == '1') || (PREV_NEXT_BAR_LOCATION == '3'))) {
	?>
	<div id="sorter" class="show_top">
	
	
	<div class="span_l"><?php echo $specials_split->display_count(TEXT_DISPLAY_NUMBER_OF_SPECIALS); ?></div>
 ...
 */
  ...
  require($template->get_template_dir('tpl_modules_products_specials_listing.php',
                                      DIR_WS_TEMPLATE,
									  $current_page_base,
									  'templates').'/tpl_modules_products_specials_listing.php');
?>
<!-- eof: specials -->
<?php
  if ($show_split_page&& ($specials_split->number_of_rows > 0) && ((PREV_NEXT_BAR_LOCATION == '2') || (PREV_NEXT_BAR_LOCATION == '3'))) {
?>
	<div  class="scott">
		<?php echo TEXT_RESULT_PAGE . ' ' . $specials_split->display_links(MAX_DISPLAY_PAGE_LINKS, zen_get_all_get_params(array('page', 'info', 'x', 'y', 'main_page'))); ?>
	</div>
<?php
  } // split page
?>
