<div class="footer">	
  ...
  <div class="<?php echo (zen_page_path_check($current_page_base,$main_page_content_chk))?'copyright2':'copyright';?>">
				<ul>
					<li><a rel="nofollow" href="<?php echo zen_href_link(FILENAME_DEFAULT);?>"><?php echo HEADER_TITLE_CATALOG;?></a></li><li>|</li>
					<li><a rel="nofollow" href="<?php echo zen_href_link(FILENAME_SITE_MAP);?>"><?php echo HEADER_TITLE_SITEMAP;?></a></li><li>|</li>
					<li><a rel="nofollow" href="<?php echo zen_href_link(FILENAME_ACCOUNT);?>"><?php echo HEADER_TITLE_MY_ACCOUNT;?></a><li>|</li></li>
					<li><a rel="nofollow" href="<?php echo zen_href_link(FILENAME_SHOPPING_CART);?>"><?php echo HEADER_TITLE_CART_CONTENTS;?></a><li>|</li></li>
					<li><a rel="nofollow" href="<?php echo zen_href_link(FILENAME_CHECKOUT_SHIPPING);?>"><?php echo HEADER_TITLE_CHECKOUT;?></a><li>|</li></li>
					<li><a rel="nofollow" href="<?php echo zen_href_link(FILENAME_ABOUT_US);?>"><?php echo HEADER_TITLE_ABOUT_US;?></a><li>|</li></li>
					<li><a rel="nofollow" href="<?php echo zen_href_link(FILENAME_CONTACT_US);?>"><?php echo HEADER_TITLE_CONTACT_US;?></a></li>
...
<script type="text/javascript">
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-9657837-4']);
