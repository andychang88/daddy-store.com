...
<div class="choosePayAddress">
<fieldset>
<legend><?php echo TABLE_HEADING_ADDRESS_BOOK_ENTRIES; ?></legend>
<?php
      require($template->get_template_dir('tpl_modules_change_checkout_payment_address_book.php',
	                                       DIR_WS_TEMPLATE, 
										   $current_page_base,
										   'templates/fec').'/' .'tpl_modules_change_checkout_payment_address_book.php');
?>
</fieldset>
<?php
     }
