...
?>
<div class="span_l"><?php echo $products_new_split->display_count(TEXT_DISPLAY_NUMBER_OF_PRODUCTS_NEW); ?></div>
<?php
  }
?>
<div class="span_r">
...
?><?php echo TEXT_INFO_SORT_BY; ?>
    <select name="disp_order" onchange="this.form.submit();" id="disp-order-sorter" class="select_p">
