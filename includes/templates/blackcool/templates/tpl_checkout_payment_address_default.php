...
?>
        <h2><?php echo   TEXT_CURRENT_PAYMENT_ADDRESS_TITLE;?></h2>
        <p><?php echo zen_address_label($_SESSION['customer_id'], $_SESSION['billto'], true, ' ', '<br />'); ?>	      
		</p>
		<hr />
		   ...
		   <tbody>
		      <tr>
			      <td width="50%" style="border-right:1px solid #CCFF66;">
						...
						<?php echo zen_draw_form('checkout_address', zen_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '','SSL'),
											'post','onsubmit="return check_new_payment_address_form();" id="new_payment_address_form"');
						 ?>
						...
						<?php 
						 ...
						 <div class="weiter">
							...
							?>
							  ...
							  <?php echo '<a href="' . zen_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL') . '">
				  ...
				  <td width="50%" valign="top">
					   <?php if ($addresses_count > 1) {
						?>
						 ...
						 <?php echo zen_draw_form('checkout_address', zen_href_link(FILENAME_CHECKOUT_PAYMENT_ADDRESS, '', 'SSL'),
												  'post',' id="choose_payment_address_form"');
						 ?>
						 <h5><?php echo TEXT_OLD_PAYMENT_ADDRESS; ?></h5>
						 <?php
