...
class language extends base {
  ...
  function language($lng = '') {
    ...
    while (!$languages->EOF) {
	  ...
	  //############Begin:language change with currency##############
	  /**************modified by john 2010-07-03**********/
	  if($languages->fields['code']=='en'){
	     $this->catalog_languages[$languages->fields['code']]['currency_code']='USD';
      }else{
	     $this->catalog_languages[$languages->fields['code']]['currency_code']='EUR';
	  }
	  //############End:language change with currency##############
      $languages->MoveNext();
    }
